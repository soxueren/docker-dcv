# docker-dcv-vnc from nvidia-ubuntu base image
基于nvidia/cuda:8.0-runtime-ubuntu16.04镜像制作包括tigervnc-server、nice-dcv-2017的docker镜像
...
## 运行容器
```
nvidia-docker run -it   --rm --name=dcv  --privileged=true -p 5901:5901  -p 8443:8443   -v /usr/lib:/usr/lib64/nvidia docker-dcv-vnc:xxx
```
## 出现错误解决方法
```
